angular.module('mwFormBuilder').constant('MW_QUESTION_TYPES', [
  'text',
  'textarea',
  'radio',
  'checkbox',
  ...
  'image',
  'paragraph'
]).factory('mwFormBuilderOptions', [
  "MW_ELEMENT_TYPES",
  "MW_QUESTION_TYPES",
  function mwFormBuilderOptionsFactory(MW_ELEMENT_TYPES, MW_QUESTION_TYPES){
