...
app.config([
  ...
  function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider, $translateProvider) {
    ...
    $stateProvider.state('home', {
      ...
      url: '/users',
      templateUrl: '/partials/users/template.html',
      controller: 'UsersController'
    }).state('user.survey', {
	...
	'surveyItems@user.survey': {
      ...
      url: '/featured',
      templateUrl: '/partials/admin/featured.html',
      controller: 'FeaturedSurveysController'
	...
	formData: function() {
      ...
      url: '/surveys',
      templateUrl: '/partials/admin/manage_surveys.html',
      controller: 'AdminSurveysController',
      resolve: {
	formData: function() {
	  return {
