...
*/
  ...
  .state('admin.show_survey', {url: '/surveys/:survey_id', templateUrl: '/partials/surveys/show.html', controller: 'AdminSurveysController'})
  .state('admin.survey', {url: '/surveys/:survey_id', templateUrl: '/partials/survey_items/show.html', controller: 'SurveyController'})
